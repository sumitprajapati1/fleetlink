...
const validateAvailabilityQuery = [
    ...
    query('fromPincode').matches(/^[0-9]{6}$/).notEmpty().withMessage('From pincode is required'),
    query('toPincode').matches(/^[0-9]{6}$/).notEmpty().withMessage('To pincode is required'),
...
export { validateVehicle, validateAvailabilityQuery, createVehicle, getAvailableVehicles, getVehicles };