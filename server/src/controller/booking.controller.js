...
const validateBooking = [
    ...
    body('fromPincode').matches(/^[0-9]{6}$/).withMessage('From pincode is required'),
    body('toPincode').matches(/^[0-9]{6}$/).withMessage('To pincode is required'),
...
export { validateBooking, createBooking, getBookings, getBookingById, cancelBooking };